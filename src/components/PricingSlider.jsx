...
const TIERS = [
  {
    ...
    features: [
      'Every message gets an instant reply — no lead left waiting',
  ...
  },
  {
    ...
    features: [
      ...
      'Confirms the booking automatically — client gets a confirmation straight away',
      'No double bookings and no back-and-forth "what time works for you?"',
  ...
  },
  {
    ...
    features: [
      ...
      'Re-contacts clients who went quiet and brings them back into conversation',
      'Books meetings and logs everything — nothing gets forgotten',
    ],
  },
  {
